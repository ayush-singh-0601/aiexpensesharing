...
const DashboardPage = () => {
    ...
    <div className="container mx-auto py-6 space-y-6">
       ...
       {isLoading ? (<div className="w-full py-12 flex justify-center">
       ...
       <div className="flex items-center justify-between">
        ...
        <Button asChild><Link href='/expenses/new'>
...
<div className="space-y-6">
    <Card>
              <CardHeader className="pb-3 flex item-center justify-between">
                <CardTitle >
                  Balance Details
                </CardTitle>
