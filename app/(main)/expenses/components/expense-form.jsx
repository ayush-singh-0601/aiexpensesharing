...
const expenseSchema = z.object({
    ...
    amount: z.string()
        ...
        .refine((val) => !isNaN(parseFloat(val)) && parseFloat(val) > 0, {
            message: "Amount must be in positive number"
        }),
    category: z.string().optional(),
    date: z.date(),
    paidByUserId: z.string().min(1, "Payer is required"),
    splitType: z.enum(["equal", "percentage", "equal"]),
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <Input id="description" placeholder="Lunch, Movie Tickets, etc." {...register("description")} />
                        {errors.description && (<p className="text-sm text-red-500">{errors.description.message}</p>)}
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="amount"> Amount</Label>
                        <Input id="amount" placeholder="0.00" {...register("amount")} type="number" step="0.01" min="0.01" />
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button variant="outline" className={cn(
                                    "w-full justify-start text-lrft font-normal",
                ...
                <div className="space-y-2">
                    ...
                    <Tabs defaultValue="equal" onValueChange={(value)=> setValue("splitType", value)}>
                        ...
                        <TabsContent value="equal" className="pt-4">
                            ...
                            <SplitSelector type="equal" amount={parseFloat(amountValue) || 0 } participants={participants}
                         ...
                         <TabsContent value="percentage"  className="pt-4">
                            ...
                            amount={parseFloat(amountValue) || 0 } participants={participants}
                            paidByUserId={paidByUserId} onSplitsChange={setSplits}/>
                        </TabsContent>
                         <TabsContent value="exact"  className="pt-4">
                            <p className="text-sm text-muted-foreground">Split by exact amount</p>
